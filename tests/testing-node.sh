...
# proj_dpath="/home/souto/Repos/ACER-PISA-2025-FT/pisa_2025ft_translation_zh-Hant-ZZ_reconciliation"
echo "starting point:"
tree $proj_dpath/tm
perl -i -pe 's~(?<=(itory|local)="source/)[\w-]+~01_COS_SCI-A_N~g' $proj_dpath/omegat.project
...
node code/arrange_tmx_files_with_extension.js --repo  $proj_dpath && find $proj_dpath/tm -name '*.tmx.zip'
echo '---'
